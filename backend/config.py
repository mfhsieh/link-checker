...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.SESSION_EXPIRE_SECONDS: int = int(os.environ.get("SESSION_EXPIRE_SECONDS", "28800"))
        ...
        # 帳號鎖定時間（秒），預設 15 分鐘
        self.LOGIN_LOCKOUT_SECONDS: int = int(os.environ.get("LOGIN_LOCKOUT_SECONDS", "900"))
