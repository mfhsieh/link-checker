...
class TopbarPassword extends HTMLElement {
    ...
    render() {
        ...
        const { group: currentPwdGroup } = createInputGroup('current-password', '現有密碼');
        ...
        const { group: confirmPwdGroup } = createInputGroup('confirm-password', '確認新密碼');
    ...
    setupEvents() {
        ...
        const pwdStrengthLabel = this.shadowRoot.getElementById('pwd-strength-label');
        ...
        form.addEventListener('submit', async (e) => {
            e.preventDefault();
            const currentPwd = this.shadowRoot.getElementById('current-password').value;
            const newPwd = newPwdInput.value;
            const confirmPwd = this.shadowRoot.getElementById('confirm-password').value;
