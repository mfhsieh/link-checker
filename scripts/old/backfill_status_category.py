...
from crawler.models import CrawlQueue, ExternalLink
from crawler.utils import determine_external_link_status_category, determine_internal_link_status_category
