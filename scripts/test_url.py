...
def get_test_crawler_config(
    ...
    return CrawlerConfig(
        ...
        social_domains=final_cfg.get("social_domains", [])  # type: ignore[arg-type]
        ...
        ssl_exempt_domains=final_cfg.get("ssl_exempt_domains", [])  # type: ignore[arg-type]
        if isinstance(final_cfg.get("ssl_exempt_domains"), list)
        else [],
        ignore_extensions=final_cfg.get("ignore_extensions", [])  # type: ignore[arg-type]
        if isinstance(final_cfg.get("ignore_extensions"), list)
        else [],
        ignore_regexes=final_cfg.get("ignore_regexes", [])  # type: ignore[arg-type]
        if isinstance(final_cfg.get("ignore_regexes"), list)
        else [],
        mime_type_filter=final_cfg.get("mime_type_filter", {})  # type: ignore[arg-type]
